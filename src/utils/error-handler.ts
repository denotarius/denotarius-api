...
export const notFoundHandler = (_request: FastifyRequest, reply: FastifyReply): FastifyReply => {
...
export const handle400 = (reply: FastifyReply, error: FastifyError): FastifyReply =>
...
export const handle400Custom = (reply: FastifyReply, message: string): FastifyReply =>
  reply.code(400).header('Content-Type', 'application/json; charset=utf-8').send({
    error: 'Bad Request',
    message: message,
    status_code: 400,
...
export const handle402 = (reply: FastifyReply): FastifyReply =>
  reply.code(402).header('Content-Type', 'application/json; charset=utf-8').send({
...
export const handle403Custom = (reply: FastifyReply, message: string): FastifyReply =>
  reply.code(403).header('Content-Type', 'application/json; charset=utf-8').send({
    error: 'Forbidden',
    message: message,
    status_code: 403,
